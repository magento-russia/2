<?php
class Df_C1_Cml2_Processor_Product_AddExternalId extends Df_Core_Model {
	/** @return string */
	...
	/**
	 * @used-by Df_C1_Cml2_Export_Processor_Catalog_Product::getExternalId()
	 * @used-by Df_C1_Cml2_Import_Data_Entity_Order_Item::getProduct()
	 * @static
	...
	public static function p(Df_Catalog_Model_Product $product, $externalId) {
		/** @var Df_C1_Cml2_Processor_Product_AddExternalId $processor */
