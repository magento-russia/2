 ...
 */
class Df_C1_Config_Source_WhichDescriptionFieldToUpdate extends Df_Admin_Config_Source {
	/**
	 * @override
	 ...
	 * @used-by Df_C1_Cml2_Import_Processor_Product_Type::getDescription()
	 * @used-by Df_C1_Cml2_Import_Processor_Product_Type::getDescriptionShort()
	 */
	const V__BOTH = 'both';
	/**
	 * @used-by toOptionArrayInternal()
