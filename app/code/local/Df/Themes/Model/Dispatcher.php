<?php
class Df_Themes_Model_Dispatcher {
	/**
	 ...
	 * @return void
	 */
	public function controller_action_postdispatch_ajax_index_options(Varien_Event_Observer $observer) {
		try {
			if (df_enabled(Df_Core_Feature::LOCALIZATION) && @class_exists('Excellence_Ajax_Helper_Data')) {
				/** @var string $phrase */
