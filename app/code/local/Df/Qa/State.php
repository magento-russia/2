...
class Df_Qa_State extends Df_Core_Model {
		...
		if (!isset($this->{__METHOD__})) {
			...
			try {
				...
				$resultA = array_filter(array_map(array(__CLASS__, 'param'), array(
					array('Файл', str_replace(DS, '/', df_trim_text_left($this->filePath(), BP . DS)))
	...
	/**
	 * @used-by Df_Qa_Method::raiseErrorParam()
	...
	/**
	 * @used-by Df_Qa_Method::raiseErrorParam()
	 * @used-by Df_Qa_Method::raiseErrorResult()
	 * @used-by Df_Qa_Method::raiseErrorVariable()
	 * @return string
	 */
	...
	protected function _construct() {
		parent::_construct();
		$this->_prop(self::$P__SHOW_CONTEXT, DF_V_BOOL);
	}

	/**
	 * @used-by __toString()
	 * @used-by i()
	 * @var Df_Qa_State|null
	 */
	private $_next;
	/** @var string */
	...
	/**
	 * @used-by Df_Qa_Method::caller()
	 * @param array(string => string|int) $stateA
	 * @param Df_Qa_State|null $previous [optional]
	 * @param bool $showContext [optional]
	 * @return Df_Qa_State
	 */
	public static function i(array $stateA, Df_Qa_State $previous = null, $showContext = false) {
