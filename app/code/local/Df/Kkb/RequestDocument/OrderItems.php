<?php
class Df_Kkb_RequestDocument_OrderItems extends \Df\Xml\Generator\Document {
	/**
	 * @override
	...
	protected function _construct() {
		parent::_construct();
		$this->_prop(self::P__REQUEST_PAYMENT, Df_Kkb_Request_Payment::class);
	}

	const P__REQUEST_PAYMENT = 'request_payment';
	/**
	 * @static
	 * @param Df_Kkb_Request_Payment $requestPayment
	 * @return Df_Kkb_RequestDocument_OrderItems
	 */
	public static function i(Df_Kkb_Request_Payment $requestPayment) {
