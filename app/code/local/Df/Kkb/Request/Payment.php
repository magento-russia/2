...
class Df_Kkb_Request_Payment extends Df_Payment_Request_Payment {
	...
	private function getDocumentOrderItems() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_Kkb_RequestDocument_OrderItems::i($this);
		}
		return $this->{__METHOD__};
	}
	
	/** @return Df_Kkb_RequestDocument_Registration */
	private function getDocumentRegistration() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_Kkb_RequestDocument_Registration::i($this);
		}
		return $this->{__METHOD__};
	}

	/** @used-by Df_Kkb_RequestDocument_OrderItems::_construct() */
