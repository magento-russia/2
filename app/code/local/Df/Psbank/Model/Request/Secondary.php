 ...
 */
abstract class Df_Psbank_Model_Request_Secondary extends Df_Payment_Model_Request_Transaction {
	/** @return int */
	...
	/**
	 * @override
	 * @see Df_Payment_Model_Request_Secondary::getPaymentExternalId()
	 * @return string
	 */
