...
abstract class Df_Core_Model_Settings extends Df_Core_Model {
	 ...
	 * @return float
	 */
	public function getFloat($key, $store = null) {return df_float($this->v($key, $store));}
	 ...
	 * @return int
	 */
	public function int($key, $store = null) {return df_int($this->v($key, $store));}
	 ...
	 * @return int
	 */
	public function nat($key, $store = null) {return df_nat($this->v($key, $store));}
	 ...
	 * @return int
	 */
	public function nat0($key, $store = null) {return df_nat0($this->v($key, $store));}
	...
	public function getPassword($key, $store = null) {
		...
		if (!isset($this->{__METHOD__}[$cacheKey])) {
			$this->{__METHOD__}[$cacheKey] = df_decrypt($this->v($key, $store));
		}
	 ...
	 * @return bool
	 */
	public function getYesNo($key, $store = null) {return df_bool($this->v($key, $store));}
	 ...
	 * @return mixed|null
	 */
	public function v($key, $store = null) {
