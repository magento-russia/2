<?php
class Df_YandexMarket_Category_Adviser_Case extends Df_Core_Model {
	/** @return string[] */
	public function getSuggestions() {
		if (!isset($this->{__METHOD__})) {
			/** @var string[] $result  */
			$result = array();
			foreach (Df_YandexMarket_Categories::s()->getNodesAsTextArray() as $path) {
				/** @var string $path */
	 ...
	 * @static
	 * @param string $piece
	 * @return Df_YandexMarket_Category_Adviser_Case
	 */
