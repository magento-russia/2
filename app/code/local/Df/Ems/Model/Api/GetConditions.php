...
class Df_Ems_Model_Api_GetConditions extends Df_Ems_Model_Request {
	 ...
	 * @return int
	 */
	protected function _filterDeliveryTime($value) {return is_null($value) ? 0 : rm_nat($value);}
	...
	protected function _construct() {
		parent::_construct();
		$this
			->_prop(self::$P__DESTINATION, RM_V_STRING_NE)
			->_prop(self::$P__POSTING_TYPE, RM_V_STRING)
			->_prop(self::$P__SOURCE, RM_V_STRING_NE)
