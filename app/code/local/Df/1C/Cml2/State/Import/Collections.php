<?php
class Df_1C_Cml2_State_Import_Collections extends Df_Core_Model {
	/**
	...
	public function getAttributes() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_1C_Cml2_Import_Data_Collection_Attributes::i(
				Df_1C_Cml2_State_Import::s()->getFileCatalogAttributes()->getXml()
			);
		}
	...
	public function getCategories() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_1C_Cml2_Import_Data_Collection_Categories::i(
	...
	public function getOffers() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_1C_Cml2_Import_Data_Collection_Offers::i(
	...
	public function getOffersBase() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} =
				Df_1C_Cml2_State_Import::s()->getDocumentCurrentAsOffers()->isBase()
				? $this->getOffers()
				: Df_1C_Cml2_Import_Data_Collection_Offers::i(
					Df_1C_Cml2_State_Import::s()->getFileOffersBase()->getXml()
				)
			;
		}
		return $this->{__METHOD__};
	...
	public function getProducts() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_1C_Cml2_Import_Data_Collection_Products::i(
				Df_1C_Cml2_State_Import::s()->getFileCatalogProducts()->getXml()
			);
		}
		return $this->{__METHOD__};
	}
	...
	private static function state() {return Df_1C_Cml2_State::s();}
}