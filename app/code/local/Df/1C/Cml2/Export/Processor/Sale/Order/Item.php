<?php
class Df_1C_Cml2_Export_Processor_Sale_Order_Item extends Df_1C_Cml2_Export_Processor_Sale {
	...
	public function getDocumentData() {
		if (!isset($this->{__METHOD__})) {
			...
			$result = array(
				...
				,'ЦенаЗаЕдиницу' => rm_number_2f($this->getOrderItemExtended()->getPrice())
	...
	/**
	 * @used-by Df_1C_Cml2_Export_Processor_Sale_Order::getDocumentData_OrderItems()
	 * @static
	 * @param Mage_Sales_Model_Order_Item $orderItem
	 * @return Df_1C_Cml2_Export_Processor_Sale_Order_Item
	 */
