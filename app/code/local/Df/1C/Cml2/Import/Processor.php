<?php
abstract class Df_1C_Cml2_Import_Processor extends Df_1C_Cml2 {
	/**
	 * @abstract
	 * @return void
	 */
	...
	/**
	 * @used-by Df_1C_Cml2_Import_Processor_Product_Type::getProductDataNewOrUpdateBase()
	 * @param string $key
	 * @return mixed
	 */
	 ...
	 * @used-by storeId()
	 * @used-by Df_1C_Cml2_Import_Processor_Product_Type::getProductDataNewOnly()
	 ...
	 * @used-by _construct()
	 * @used-by getEntity()
	 * @used-by Df_1C_Cml2_Import_Processor_Category::i()
	 * @used-by Df_1C_Cml2_Import_Processor_Order::_construct()
	 * @used-by Df_1C_Cml2_Import_Processor_Order::i()
	 * @used-by Df_1C_Cml2_Import_Processor_Order_Item::_construct()
	 * @used-by Df_1C_Cml2_Import_Processor_Order_Item::ic()
	 * @used-by Df_1C_Cml2_Import_Processor_Product::_construct()
	 * @used-by Df_1C_Cml2_Import_Processor_Product::ic()
	 * @used-by Df_1C_Cml2_Import_Processor_ReferenceList::_construct()
	 * @used-by Df_1C_Cml2_Import_Processor_ReferenceList::i()
	 * @var string
	 */
