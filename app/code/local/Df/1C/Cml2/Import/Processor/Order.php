<?php
class Df_1C_Cml2_Import_Processor_Order extends Df_1C_Cml2_Import_Processor {
	/**
	 * @override
	 * @return void
	 */
	public function process() {
		...
		if (is_null($this->getEntity()->getOrder())) {
			 ...
			 * @see Df_1C_Cml2_Import_Data_Entity_Order_Item_Composite
			 *
...
//		;
		foreach ($this->getProductIdsToDelete() as $productId) {
			...
			/** @var Df_1C_Cml2_Import_Processor_Order_Item $processor */
//			$processor =
//				df_model(
//					$processorClassMf
//					,
//					array(
//						Df_1C_Cml2_Import_Processor_Order_Item_Add
//							::P__ENTITY_ORDER => $this->getEntity()
//						,
//						Df_1C_Cml2_Import_Processor_Order_Item_Add::P__ENTITY =>
//							$this->getEntity()->getItems()->getItemByProductId($productId)
//					)
//				)
//			;
//
//			df_assert($processor instanceof Df_1C_Cml2_Import_Processor_Order_Item);
//
//			$processor->process();
		}
	}
	...
	private function orderItemsProcess(array $productIds, $processorClass) {
		foreach ($productIds as $productId) {
			/** @var int $productId */
			Df_1C_Cml2_Import_Processor_Order_Item::ic(
				$processorClass
				, $this->getEntity()->getItems()->getItemByProductId($productId)
				, $this->getEntity()
			)->process();
	 ...
	 * @return Df_1C_Cml2_Import_Processor_Order
	 */
	public static function i(Df_1C_Cml2_Import_Data_Entity_Order $order) {
