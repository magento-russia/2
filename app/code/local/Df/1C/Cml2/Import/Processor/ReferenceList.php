<?php
/**
 * @method Df_1C_Cml2_Import_Data_Entity_Attribute_ReferenceList getEntity()
 */
class Df_1C_Cml2_Import_Processor_ReferenceList extends Df_1C_Cml2_Import_Processor {
	/**
	 * @override
	 * @return void
	 */
...
//						)
	 ...
	 * @see Df_1C_Cml2_Export_Processor_Catalog_Attribute_Real::assignExternalIdToOptions()
	...
	private function assignExternalIdToOptions(Df_Catalog_Model_Resource_Eav_Attribute $attribute) {
		...
		foreach ($attribute->getOptions() as $option) {
			...
			if (!$option->get1CId()) {
				...
				/** @var Df_1C_Cml2_Import_Data_Entity_ReferenceListPart_Item[] $importedOption */
				...
				if ($importedOptions) {
					/** @var Df_1C_Cml2_Import_Data_Entity_ReferenceListPart_Item|null $importedOption */
					$importedOption = null;
					foreach ($importedOptions as $importedOptionCurrent) {
						/** @var Df_1C_Cml2_Import_Data_Entity_ReferenceListPart_Item $importedOptionCurrent */
					...
					if ($importedOption) {
						df_assert($importedOption instanceof Df_1C_Cml2_Import_Data_Entity_ReferenceListPart_Item);
	...
	/**
	 * @static
	 * @param Df_1C_Cml2_Import_Data_Entity_Attribute_ReferenceList $refList
	 * @return Df_1C_Cml2_Import_Processor_ReferenceList
	 */
	public static function i(Df_1C_Cml2_Import_Data_Entity_Attribute_ReferenceList $refList) {
	...
	public static function removeDuplicateOptionsWithTheSameExternalId(
		...
		$options->addFieldToSelect(Df_1C_Const::ENTITY_EXTERNAL_ID);
		/** @var string[] $alreadyAssigned */
