<?php
class Df_1C_Cml2_Import_Processor_Product_Part_Images
	...
	/**
	 * @used-by Df_1C_Cml2_Action_Catalog_Import::importProductsConfigurablePartImages()
	 * @used-by Df_1C_Cml2_Action_Catalog_Import::importProductsSimplePartImages()
	 * @static
