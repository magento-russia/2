<?php
class Df_1C_Cml2_Import_Data_Entity_ProductPart_AttributeValue_Custom_Option
	extends Df_1C_Cml2_Import_Data_Entity_ProductPart_AttributeValue_Custom {
	/**
	 * @override
	 * @return string
	 */
	...
	private function getOption() {
		if (!isset($this->{__METHOD__})) {
			...
			$options->addFieldToFilter(Df_1C_Const::ENTITY_EXTERNAL_ID, $this->getExternalId());
			if (!$options->count()) {
