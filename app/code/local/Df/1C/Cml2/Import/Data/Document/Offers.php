<?php
class Df_1C_Cml2_Import_Data_Document_Offers extends Df_1C_Cml2_Import_Data_Document {
	/** @return string */
	...
	/**
	 * @used-by storeInSession()
	 * @used-by Df_1C_Cml2_State_Import::getFileOffersPrices()
	 */
	const TYPE__PRICES = 'offers_prices';
	/**
	 * @used-by storeInSession()
	 * @used-by Df_1C_Cml2_State_Import::getFileOffersStock()
	 */
