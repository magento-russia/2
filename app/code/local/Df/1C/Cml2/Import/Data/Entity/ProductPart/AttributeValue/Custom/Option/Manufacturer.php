<?php
class Df_1C_Cml2_Import_Data_Entity_ProductPart_AttributeValue_Custom_Option_Manufacturer
	extends Df_1C_Cml2_Import_Data_Entity_ProductPart_AttributeValue_Custom_Option {
	/**
	 * @override
	...
	public function getAttributeMagento() {
		if (!isset($this->{__METHOD__})) {
			...
			Df_1C_Cml2_Import_Processor_ReferenceList::removeDuplicateOptionsWithTheSameExternalId(
				$result
			);
	 ...
	 * @see Df_1C_Cml2_Import_Data_Entity_ProductPart_AttributeValue_Custom_Option::getValue()
	...
	protected function createMagentoAttribute() {
		/** @var Df_1C_Cml2_Import_Data_Entity_Attribute_ReferenceList $referenceList */
	...
	protected function getGroupForAttribute(Df_Catalog_Model_Resource_Eav_Attribute $attribute) {
		...
		return
			('Изготовитель' === $attribute->_getData(Df_1C_Const::ENTITY_EXTERNAL_ID))
