<?php
abstract class Df_1C_Cml2_Import_Data_Entity extends Df_Core_Xml_Parser_Entity {
	/** @return string */
	...
	protected function getRequisiteValue($name) {
		/** @var Df_1C_Cml2_Import_Data_Entity_RequisiteValue $requisiteValue */
	...
	protected function getRequisiteValues() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = Df_1C_Cml2_Import_Data_Collection_RequisiteValues::i($this->e());
		}
		return $this->{__METHOD__};
	}
