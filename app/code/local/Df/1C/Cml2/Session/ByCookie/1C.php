<?php
class Df_1C_Cml2_Session_ByCookie_1C extends Df_Core_Model_Session_Custom_Primary {
	/**
	 * @used-by
	 * @return string|null
	 */
	...
	/**
	 * @param string $value
	 * @return Df_1C_Cml2_Session_ByCookie_1C
	 */
	 ...
	 * @return string
	 */
	protected function getSessionIdCustom() {return Df_1C_Cml2_Cookie::s()->getSessionId();}
