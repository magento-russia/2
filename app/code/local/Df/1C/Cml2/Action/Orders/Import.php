<?php
class Df_1C_Cml2_Action_Orders_Import extends Df_1C_Cml2_Action {
	/**
	 * Обратите внимание,
	...
	protected function _process() {
		...
		foreach ($this->getOrders() as $entityOrder) {
			/** @var Df_1C_Cml2_Import_Data_Entity_Order $entityOrder */
			Df_1C_Cml2_Import_Processor_Order::i($entityOrder)->process();
		}
