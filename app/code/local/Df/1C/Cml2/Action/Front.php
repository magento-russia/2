<?php
class Df_1C_Cml2_Action_Front extends Df_1C_Cml2_Action {
	/**
	 * @override
		...
		if ($this->rmRequest()->isCheckAuth()) {
			...
			switch ($this->rmRequest()->getType()) {
				case Df_1C_Cml2_InputRequest_Generic::TYPE__GET_CATALOG:
					...
					break;
				case Df_1C_Cml2_InputRequest_Generic::TYPE__CATALOG:
					$this->action_catalog();
					break;
				case Df_1C_Cml2_InputRequest_Generic::TYPE__ORDERS:
					$this->action_orders();
					break;
				case Df_1C_Cml2_InputRequest_Generic::TYPE__REFERENCE:
	...
	private function action_catalog() {
		switch($this->rmRequest()->getMode()) {
			 ...
			 */
			case Df_1C_Cml2_InputRequest_Generic::MODE__DEACTIVATE:
				/** @uses Df_1C_Cml2_Action_Catalog_Deactivate */
				$this->delegate('Catalog_Deactivate');
				break;
			case Df_1C_Cml2_InputRequest_Generic::MODE__FILE:
				$this->action_upload();
				break;
			case Df_1C_Cml2_InputRequest_Generic::MODE__IMPORT:
				/** @uses Df_1C_Cml2_Action_Catalog_Import */
	...
	private function action_catalogExport() {
		switch($this->rmRequest()->getMode()) {
			case Df_1C_Cml2_InputRequest_Generic::MODE__INIT:
				...
				break;
			case Df_1C_Cml2_InputRequest_Generic::MODE__QUERY:
				/** @var bool $process */
				$process = !$this->flag_catalogHasJustBeenExported();
				try {
					/**
					 * @uses Df_1C_Cml2_Action_Catalog_Export_Finish
					 * @uses Df_1C_Cml2_Action_Catalog_Export_Process
					 */
	...
	private function action_orders() {
		switch($this->rmRequest()->getMode()) {
			...
			case Df_1C_Cml2_InputRequest_Generic::MODE__INIT:
				...
				break;
			case Df_1C_Cml2_InputRequest_Generic::MODE__QUERY:
				/** @uses Df_1C_Cml2_Action_Orders_Export */
				$this->delegate('Orders_Export');
				break;
			case Df_1C_Cml2_InputRequest_Generic::MODE__SUCCESS:
	...
	private function action_reference() {
		switch($this->rmRequest()->getMode()) {
			case Df_1C_Cml2_InputRequest_Generic::MODE__FILE:
				...
				break;
			case Df_1C_Cml2_InputRequest_Generic::MODE__IMPORT:
				/** @uses Df_1C_Cml2_Action_Reference_Import */
	...
	/**
	 * @uses Df_1C_Cml2_Action_GenericImport_Upload
	 * @return void
	 */
	...
	private function checkLoggedIn() {
		...
		$sessionId = Df_1C_Cml2_Cookie::s()->getSessionId();
