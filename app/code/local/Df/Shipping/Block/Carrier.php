...
class Df_Shipping_Block_Carrier extends Df_Core_Block_Abstract_NoCache {
	...
	protected function _toHtml() {
		return df_concat_n(
			rm_tag('dt', array(), rm_e($this->parent()->getCarrierName($this[self::$P__CODE])))
			/** @uses renderRate() */
			,rm_tag('dd', array(), rm_tag_list(array_map(array($this, 'renderRate'), $this->rates())))
		);
	}
	...
	protected function _construct() {
		...
		$this
			...
			->_prop(self::$P__RATES, RM_V_ARRAY)
		;
	}
	/** @var string */
