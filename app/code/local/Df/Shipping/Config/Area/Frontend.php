...
class Frontend extends \Df\Shipping\Config\Area {
	/** @return string */
	...
	/** @return bool */
	public function needDisplayDiagnosticMessages() {return
		$this->getVarFlag(self::$V__DISPLAY_DIAGNOSTIC_MESSAGES, true)
	;}
	 ...
	 * @return array
	 */
	protected function getLegacyKeys() {return ['active', 'title'];}
