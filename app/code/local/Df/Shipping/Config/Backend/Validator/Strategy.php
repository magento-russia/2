<?php
namespace Df\Shipping\Config\Backend\Validator;
abstract class Strategy extends \Df_Admin_Config_Backend_Validator_Strategy {
	/**
	 ...
	 * @see \Df\Shipping\Config\Backend\Validator\Strategy\Origin\SpecificCountry
	 ...
	 * @return string
	 */
	protected function moduleTitle() {return
		df_config_adminhtml()->getSystemConfigNodeLabel(
