...
abstract class Df_Shipping_Collector extends Df_Shipping_Model_Bridge {
	...
	private function fromBase($amount) {
		return rm_currency_h()->convertFromBase($amount, $this->currencyCode(), $this->store());
	}
	...
	private function toBase($amount) {
		return rm_currency_h()->convertToBase($amount, $this->currencyCode(), $this->store());
	}
	...
	public static function r(
		...
		$i = rm_ic(rm_convention($carrier, 'Collector', __CLASS__), __CLASS__, array(
