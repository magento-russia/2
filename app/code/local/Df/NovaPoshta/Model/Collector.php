<?php
class Df_NovaPoshta_Model_Collector extends Df_Shipping_Model_Collector_Simple_Ua {
	/**
	 * @used-by _collect()
	...
	protected function _collect() {
		 ...
		 * @link http://novaposhta.ua/posulku
		 */
...
//				'date' => Zend_Date::now()->toString('dd.MM.yyyy')
//				,'recipientCityId' => $this->locationDestId()
//				,'recipientCity' => $this->cityDest()
//				,'senderCityId' => $this->locationOrigId()
//				,'senderCity' => $this->cityOrig()
//			));
			/**
			 * «24 марта 2015»
			 * @var string $dateS
