...
class Df_Payment_Model_Config_Facade extends Df_Payment_Model_Config_Abstract {
	...
	public function admin() {return $this->getConfig($this->getAdminConfigClass());}

	/** @return Df_Payment_Model_Config_Area_Frontend */
	public function frontend() {return $this->getConfig($this->getFrontendConfigClass());}

	/** @return Df_Payment_Model_Config_Area_No */
	public function noArea() {return $this->getConfig(Df_Payment_Model_Config_Area_No::_CLASS);}

	/** @return Df_Payment_Model_Config_Area_Service */
	public function service() {return $this->getConfig($this->getServiceConfigClass());}
	...
	/** @return string */
	protected function getAdminConfigClass() {return $this->cfg(self::P__CONFIG_CLASS__ADMIN);}

	/** @return string */
	protected function getFrontendConfigClass() {return $this->cfg(self::P__CONFIG_CLASS__FRONTEND);}

	/** @return string */
	protected function getServiceConfigClass() {return $this->cfg(self::P__CONFIG_CLASS__SERVICE);}

	/** @return Df_Payment_Model_Config_Area_Abstract[] */
	protected function getStandardKeyProcessors() {
		return array($this->frontend(), $this->admin(), $this->service());
	}
