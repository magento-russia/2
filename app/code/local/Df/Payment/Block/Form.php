...
/**
 * Обратите внимание, что класс \Df\Payment\Block\Form не унаследован от Mage_Payment_Block_Form,
 ...
 */
class Form extends \Df_Core_Block_Template_NoCache {
	/**
	 * заимствовано из Mage_Payment_Block_Form
	 * @see \Mage_Payment_Block_Form::canCreateBillingAgreement
	 * @return bool
	 */
	public function canCreateBillingAgreement() {return $this->method()->canCreateBillingAgreement();}
