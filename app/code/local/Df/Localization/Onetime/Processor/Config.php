<?php
class Df_Localization_Onetime_Processor_Config extends Df_Core_Model {
	/** @return void */
	...
	/** @return Df_Localization_Onetime_Dictionary_Config_Entry */
	...
	/**
	 * @param Df_Localization_Onetime_Dictionary_Config_Entry $entry
	 * @return Df_Localization_Onetime_Processor_Config
	 */
	public static function i(Df_Localization_Onetime_Dictionary_Config_Entry $entry) {
