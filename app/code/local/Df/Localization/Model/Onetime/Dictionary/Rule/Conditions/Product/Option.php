<?php
class Df_Localization_Model_Onetime_Dictionary_Rule_Conditions_Product_Option
	extends Df_Localization_Model_Onetime_Dictionary_Rule_Conditions_Abstract {
	/**
	 * @override
	 * @return string
	 */
	protected function getEntityClass() {return Df_Catalog_Model_Product_Option_Title::_CLASS;}
