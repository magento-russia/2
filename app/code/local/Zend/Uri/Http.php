 ...
 * Добавил поддержку кириллических веб-адресов.
 * Исходный код класса взял из Magento CE 1.9.0.1
 * Проверял работоспособность во всех версиях в Magento CE >= 1.4.
 * Правки внёс в 2 местах:
 * 1) @see Zend_Uri_Http::CHAR_ALNUM
 * 2) @see Zend_Uri_Http::validatePath()
 */
/**
 * @see Zend_Uri
 */
...
class Zend_Uri_Http extends Zend_Uri
{
	 ...
	 * на
	 * const CHAR_ALNUM    = 'A-Za-z0-9\p{Cyrillic}';
	 */
	const CHAR_ALNUM    = 'A-Za-z0-9\p{Cyrillic}';
    const CHAR_MARK     = '-_.!~*\'()\[\]';
    const CHAR_RESERVED = ';\/?:@&=+$,';
